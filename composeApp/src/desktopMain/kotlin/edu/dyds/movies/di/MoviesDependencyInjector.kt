...
import edu.dyds.movies.data.external.tmdb.TMDBMoviesDataSource
...
object MoviesDependencyInjector {
    private val tmdbDataSource = TMDBMoviesDataSource()
    private val moviesRepository = MoviesRepositoryImpl(tmdbDataSource, tmdbDataSource, LocalMoviesDataSourceImpl())
