...
import edu.dyds.movies.data.external.MovieDetailExternalSourceBroker
...
object MoviesDependencyInjector {
    ...
    private val detailExternalSourceBroker = MovieDetailExternalSourceBroker(tmdbDataSource, omdbDataSource)
    private val moviesRepository = MoviesRepositoryImpl(tmdbDataSource, detailExternalSourceBroker, MoviesLocalSourceImpl())
