...
import edu.dyds.movies.data.external.omdb.proxy.OMDBMoviesProxyImpl
import edu.dyds.movies.data.external.tmdb.TMDBMoviesExternalSourceImpl
import edu.dyds.movies.data.external.tmdb.proxy.TMDBMoviesProxyImpl
...
object MoviesDependencyInjector {
    ...
    private val tmdbMoviesProxy = TMDBMoviesProxyImpl(tmdbMoviesExternalSource)
    private val omdbMoviesProxy = OMDBMoviesProxyImpl(omdbMoviesExternalSource)
